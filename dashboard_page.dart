...
import 'lib/pages/virtual_id_page.dart';
import 'lib/pages/profile_page.dart';
import 'lib/pages/create_assignment_page.dart';
import 'lib/pages/schedule_class_page.dart';
import 'lib/pages/upload_material_page.dart';
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const VirtualIdPage()),
                        );
                      },
