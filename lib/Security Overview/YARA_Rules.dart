...
import 'Yara/Test_Yara.dart';
import 'Yara/new_yara.dart';
                  ...
                  child: ActionButton(
                    ...
                    onPressed: () {
                      showGeneralDialog(
                        ...
                        barrierLabel: "TestYara",
                        pageBuilder: (context, anim1, anim2) => const TestYaraPage(),
                      );
                    },
                    isFilled: false,
                  ),
                  ...
                  child: ActionButton(
                    ...
                    onPressed: () {
                      showGeneralDialog(
                        context: context,
                        barrierDismissible: true,
                        barrierLabel: "NewYara",
                        pageBuilder: (context, anim1, anim2) => const NewYaraPage(),
                      );
                    },
                    isFilled: true,
                  ),
