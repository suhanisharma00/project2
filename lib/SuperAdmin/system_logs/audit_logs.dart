      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text("Login Audit Logs", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
        ...
        children: [
          const Row(
            children: [
              ...
              SizedBox(width: 8),
              Text("Filter Logs", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            ],
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text("Detailed records of user and system activities.", style: TextStyle(color: Colors.white60, fontSize: 12)),
          const SizedBox(height: 16),
          Row(
            children: [
